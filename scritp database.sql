...
(
	...
	TinhTrangGhe nvarchar(50) check(TinhTrangGhe in(N'Trống', N'Đã đặt', N'Ðang đặt')),
...
--================================================================================
insert into GHE
values('A1',N'Trống','XE001')
insert into GHE
values('A10',N'Trống','XE001')
insert into GHE
values('B1',N'Đã đặt','XE001')
insert into GHE
values('B10',N'Ðang đặt','XE001')

insert into GHE
values('A1',N'Đã Đặt','XE002')
insert into GHE
values('A10',N'Trống','XE002')
insert into GHE
values('B1',N'Ðang đặt','XE002')
insert into GHE
values('B10',N'Trống','XE002')
--================================================================================
...
select * from NhanVien where TenDangNhapNV='thanhphi1996'